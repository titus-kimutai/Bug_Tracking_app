...
//logic fo assigning a user to a project to do 
...
//get a single project member from the database 
...
//getting project member from the database 
...
//removing a user from the assigned project in the list
